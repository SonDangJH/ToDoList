...
export default function EditNote({ mode, noteBoardContent, actionNote, setNoteBoardContent}) {

    return (
        <div className="relative shadow-md h-[500px] lg:h-full">
            <p className="absolute z-10 top-5 left-4 text-sm text-gray-500 flex flex-row items-center gap-2"><GoClock className="w-3 h-3"/>{"Beautiful day"}</p>
